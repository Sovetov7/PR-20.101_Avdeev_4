...
namespace PR_20._101_Avdeev_4.Entity
{
    ...
    public partial class EntitiesRK : DbContext
    {
        private static EntitiesRK context;
        public static EntitiesRK GetContext()
        {
            if (context == null)
            {
                context = new EntitiesRK();
            }

            return context;
        }
        public EntitiesRK()
            : base("name=EntitiesRK")
        {
        }
